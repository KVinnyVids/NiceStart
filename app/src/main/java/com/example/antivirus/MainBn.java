...
import com.example.antivirus.ui.main.SectionsPagerAdapter;
        ...
        mybottomNavView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (item.getItemId()==R.id.item1){
                        ...
                        Toast.makeText(MainBn.this, "Salir clicked.", Toast.LENGTH_SHORT).show();
                ...
                if (item.getItemId()==R.id.item1){
                        item.setChecked(true);
                        Toast.makeText(MainBn.this, "Roller clicked.", Toast.LENGTH_SHORT).show();
                       // removeBadge(mybottomNavView,item.getItemId());
                        viewPager1.setCurrentItem(2);
                }
                if (item.getItemId()==R.id.item1){
                        item.setChecked(true);
                        Toast.makeText(MainBn.this, "Cookie clicked.", Toast.LENGTH_SHORT).show();
                     //   removeBadge(mybottomNavView,item.getItemId());
